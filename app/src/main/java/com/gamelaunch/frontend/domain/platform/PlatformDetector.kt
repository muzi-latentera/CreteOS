...
class PlatformDetector @Inject constructor() {
    ...
    // .png is a PICO-8 cart image (.p8.png) but overwhelmingly also plain artwork, so it's only
    // trusted inside a recognised pico8 folder.
    private val ambiguousExtensions = setOf(".bin", ".iso", ".img", ".chd", ".cso", ".cue", ".zip", ".7z", ".m3u", ".png")
