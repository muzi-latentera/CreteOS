...
- 🖥️ **Dual-screen aware** — on clamshell handhelds like the **Anbernic RG DS**, eOr spreads across both panels: browse and launch from the bottom while the top screen shows the focused game's **marquee art** over a gradient that follows your Light/Dark theme. Single-screen games launch straight onto the top display, too — no setup, it's detected automatically.
